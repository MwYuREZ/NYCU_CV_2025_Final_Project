...
def main():
    ...
    # vit Model
    model_vit = vit_b_16(pretrained=True).to(device)
    ...
    # efficient net model 
    model_effi = efficientnet_b7(weights=weights).to(device)
    ...
    model_vit.load_state_dict(torch.load('../VIT/best_model.pth'))
    model_effi.load_state_dict(torch.load('../EfficientNet/best_model.pth'))
